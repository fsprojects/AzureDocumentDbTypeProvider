...
let info =
  [ "project-name", "AzureDocumentDbTypeProvider"
    "project-author", "Stewart Robertson"
    "project-summary", "A Type Provider for the Azure DocumentDb service"
    "project-github", githubLink
    "project-nuget", "http://www.nuget.org/packages/FSharp.Azure.DocumentDbTypeProvider" ]
